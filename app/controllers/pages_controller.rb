class PagesController < ApplicationController
  def index
    ...
    @keywords = "adrian, vondy, Winchester, lawyer, attorney, bankruptcy, Social Security Disability, Wills, Trusts, Estate Planning, Probate, Guardianships, Real Estate, Virginia, West Virginia"
    @selected = "index"
  end
  ...
  def directions
    ...
    @keywords = "adrian, vondy, Winchester, lawyer, attorney, bankruptcy, Social Security Disability, Wills, Trusts, Estate Planning, Probate, Guardianships, Real Estate, Virginia"
    @selected = "directions"
  end
  ...
  def bankruptcy
    ...
    @keywords = "adrian, vondy, Winchester, lawyer, attorney, bankruptcy, debt, garnishments, lawsuits, Chapter 7, Virginia, West Virginia"
  end
  ...
  def estate_planning
    ...
    @keywords = "adrian, vondy, Winchester, lawyer, attorney, wills, trusts, estates, probate, Virginia, West Virginia"
  end
  ...
  def real_estate
    ...
    @keywords = "adrian, vondy, Winchester, lawyer, attorney, real estate, closings, settlements, contracts, deeds, Virginia, West Virginia"
  end
  ...
  def social_security
    ...
    @keywords = "adrian, vondy, Winchester, lawyer, attorney, Social Security, Disability, SSI, Virginia, West Virginia"
  end
  ...
  def guardianship
    ...
    @keywords = "adrian, vondy, Winchester, lawyer, attorney, guardian, conservator"
  end
  ...
  def adrian
    ...
    @keywords = "adrian, vondy, Winchester, attorney, lawyer, bankruptcy, Social Security, guardian, conservator, Virginia"
  end
  ...
  def annette
    ...
    @keywords = "adrian, vondy, Winchester, attorney, legal assistant"
  end
  ...
  def tiffany
    ...
    @keywords = "adrian, vondy, Winchester, attorney, bankruptcy, paralegal"
  end
  ...
  def vondy
    ...
    @keywords = "adrian, vondy, Winchester, attorney, lawyer, real estate, wills, trusts, bankruptcy, probate, Virginia, West Virginia "
  end
end
