class PagesController < ApplicationController
  ...
  def estate_planning
    ...
    @description = "Winchester attorney Frederick S. Vondy is experienced in preparing wills, trusts, living wills, powers of attorney and special needs trusts, and assists executors in  probate proceedings and estate administration."
    @keywords = "Winchester lawyer attorney wills trusts estates probate"
  end
  ...
  def estate_administration
    ...
    @keywords = "Winchester lawyer attorney real estate closings settlements contracts"
  end
  ...
  def social_security
    ...
    @keywords = "Winchester lawyer attorney Social Security Disability SSI"
  end
  ...
  def adrian
    ...
    @keywords = "Winchester attorney lawyer bankruptcy Social Security guardian"
  end
  ...
  def annette
    ...
    @keywords = "Winchester attorney lawyer assistant"
  end
  ...
  def tiffany
    ...
    @keywords = "Winchester attorney lawyer bankruptcy paralegal"
  end
  ...
  def vondy
    ...
    @keywords = "Winchester attorney lawyer real estate wills trusts bankruptcy probate"
  end
end
