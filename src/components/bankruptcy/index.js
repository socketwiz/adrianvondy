...
export default function Bankruptcy() {
    document.title = 'Adrian & Vondy Bankruptcy Practice';

    return (
        <Main>
            <div className="container_omega">
                <h2 className="widgettitle">Bankruptcy</h2>
                <h4>Frequently Asked Questions</h4>

                <ol>
                    <li>
                        <h3>What do you charge for an individual/couple filing for bankruptcy?</h3>
                        <strong>Initial Consultation is Free.</strong><br />
                        <br />
                        Our fee: For straightforward cases, our fee is usally $850.00.<br />
                        <pre> 
                            ...
                            Costs: Bankruptcy Court Filing Fee:      $335.00
                            In Virginia, a filing fee 
                            for your exemption list 
                            (called a Homestead Deed)         $ 21.00 (individual)
                            42.00 (couple)

                            TOTAL STARTING FEE :  $ 1,206.00 (individual)
                            $1,227.00 (couple)

                            Not charged by my office but required by the bankruptcy court, a debtor is required to consult with a consumer credit counseling agency and obtain a pre-bankruptcy certificate stating that you have undergone consumer credit counseling and a post-bankruptcy certificate stating that you have taken a financial management course. These classes are usually done on-line and cost between $15.00 and $50.00) 
                        </pre>
                    </li>
                    <li>
                        <h3>Should I file for bankruptcy?</h3> Many people question whether they should file for bankruptcy. By the time most people are thinking about filing for bankruptcy, their finances are out of control and they have little financial choice but to declare bankruptcy and obtain a financial "Fresh Start.” 
                        <pre>    What drives people into bankruptcy? Some of the things that 
                    ...
                    <li>
                        ...
                        <pre>    a. Filing bankruptcy will stop:
                            ...
                            5) Attempts by creditors to repossess vehicles or foreclose on real estate
                    ...
                    <li>
                        ...
                        <pre>     a. What is a Chapter 7?
                            ...
                            With respect to secured debts (cars, houses), the debtor has a choice and can either reaffirm the debt and keep the home or car OR the debtor can give back the car or house and discharge the debt in bankruptcy. Most Chapter 7 cases are completed in the court system in 90 to 120 days. 
                        ...
                        To determine what is best for you , talk to your bankruptcy lawyer. PLEASE NOTE THAT WE DO NOT HANDLE CHAPTER 13 BANKRUPTCY FILINGS AT THIS TIME. THE FOLLOWING INFORMATION APPLIES TO CHAPTER 7 BANKRUPTCY PROCEEDINGS.
                    </li>
                    <li>
                        ...
                        <pre>    1) Have you filed for bankruptcy before? You are not eligible to file a bankruptcy case if you filed for bankruptcy and received a discharge within the 8 years immediately preceding your current filing. There must be 8 years between the filing of the bankruptcy petitions.

                            2) What is your income? Most low and moderate income individuals/ couples, pass the income test (In Virginia, beginning November 1, 2014, a family of 4 could have a gross yearly income of  $91,859. In West Virginia, beginning November 1, 2014, a family of 4 could have a gross yearly income of $66,009.)   Upper income individuals and couples may still qualify for a Chapter 7 bankruptcy; however, it is necessary to complete a detailed test that takes into consideration numerous factors, including house payments, car payments, payment of alimony, child care expenses, etc. Expect your bankruptcy lawyer to spend some time and effort to make sure that you qualify. Most bankruptcy lawyers charge a small fee for this service. </pre>
                    </li>
                    <li>
                        ...
                        <pre>     1) Clothes
                            ...
                            7. Burial plots 
                            8) Health aids
                            9) Usually a firearm in Virginia
                            10) Pets
                    ...
                    <li>
                        ...
                        Oh yes! Sometimes a debtor receives credit card solicitations before he or she is out of bankruptcy. BEWARE. This is not usually the type of credit you want and, remember, it may have been credit cards that got you into bankruptcy in the first place.<br />
                        <br />
                        Most mortgage companies and banks are willing to consider you for a mortgage loan after four years have passed.<br />
                        <br />
                        Likewise, if you keep a car during your bankruptcy and faithfully make your payments, you will most likely be able to get a car loan.<br />
                        <br />
                        Whether you get credit depends a lot on what you do after the bankruptcy filing, the job you have and whether you have been diligent in paying your creditors on time.
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <pre>     1) Your first consultation with the bankruptcy attorney is free. The attorney will go over how bankruptcy works and review your specific situation to see if a Chapter 7 case would be an option for you. The attorney will also give you an estimate on how much your bankruptcy filing would cost.
